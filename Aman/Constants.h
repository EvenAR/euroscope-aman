...
const HPEN VIA_FIX_COLORS[N_VIA_FIX_COLORS] = {
...
const int AMAN_TIMELINE_TICK_WIDTH_1_MIN = 4;
const int AMAN_TIMELINE_TICK_WIDTH_5_MIN = 8;
const int AMAN_TIMELINE_MAX_TICK_DENSITY = 15;
...
const int AMAN_AIRCRAFT_LINE_SEPARATION = 5;
