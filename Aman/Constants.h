...
static const HBRUSH AMAN_BRUSH_MAIN_BACKGROUND = CreateSolidBrush(RGB(50, 50, 50));
...
const HFONT AMAN_LABEL_FONT = CreateFont(15, 0, 0, 0, FW_NORMAL, 0, 0, 0, 0, 3, 2, 1, 49, "EuroScope");
...
const int AMAN_WIDTH = 350;
const int AMAN_AIRCRAFT_LINE_HEIGHT = 16;
