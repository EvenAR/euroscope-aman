...
const int N_VIA_FIX_COLORS = 8;
const HPEN VIA_FIX_PENS[N_VIA_FIX_COLORS] = {
	CreatePen(PS_SOLID, 2, RGB(0, 255, 0)),
	CreatePen(PS_SOLID, 2, RGB(0, 255, 255)),
	CreatePen(PS_SOLID, 2, RGB(255, 128, 255)),
	CreatePen(PS_SOLID, 2, RGB(204, 204, 0)),
	CreatePen(PS_SOLID, 2, RGB(255, 128, 0)),
	CreatePen(PS_SOLID, 2, RGB(102, 102, 255)),
	CreatePen(PS_SOLID, 2, RGB(204, 0, 102))
};
